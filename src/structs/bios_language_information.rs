...
impl fmt::Debug for SMBiosBiosLanguageInformation<'_> {
    fn fmt(&self, fmt: &mut fmt::Formatter) -> fmt::Result {
        ...
        .field("number_of_installable_languages", &self.number_of_installable_languages())
...
mod tests {
    ...
    fn test_bios_language_information() {
        let bios_language_information_bytes = vec![
            ...
            0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01,
            // "en|US|iso8859-1"
        ...
        assert_eq!(bios_language_information.number_of_installable_languages().expect("number_of_installable_languages field exists"), 3);
        assert_eq!(bios_language_information.flags().expect("flags field exists"), 0);

        // installable_languages tests
        let mut string_iterator = bios_language_information.installable_langauges().into_iter();
